...
namespace AgendaSIG5.App.Frontend.Pages.AgendaCitas
{
    public class Index1Model : PageModel
    {
        ...
        public IEnumerable<Agenda> agendaCitas {get; set;}

        public Index1Model(IRepositorioAgenda repoAgenda, IRepositorioPersona repoPersona, 
        ...
        public void OnGet()
        {
            agendaCitas =_repoAgenda.GetAllAgendas();            
        }
